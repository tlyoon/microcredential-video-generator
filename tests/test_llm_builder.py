    ...
    def generate_json(self, prompt, schema):
        ...
        if "DEDICATED NARRATION POLISH PASS" in prompt:
            return {
                "slides": [
                    {
                        "slide_id": "V01S01",
                        "narration": "A number by itself is not yet a useful laboratory result. Before we can interpret it, we need to know what was measured and the unit attached to that value.",
                        "tts_text": None,
                    },
                    {
                        "slide_id": "V01S02",
                    ...
                    {
                        "slide_id": "V01S04",
                        "narration": "The key habit is simple: report the measured value together with its unit. That gives the number the physical meaning it needs.",
                        "tts_text": None,
                    },
                ]
            }
        return {
            ...
            "slides": [
                {
                    "slide_type": "hook",
                    "title": "What makes a measurement meaningful?",
                    "onscreen": ["A number alone is incomplete."],
                    "narration": "A laboratory result is more than a number. We need enough context to know what the number means.",
                    "lecturer_notes": ["Use a familiar ruler example."],
                    "visual_direction": "Show an unlabeled 12.4, then reveal mm.",
                    "equation_latex": None,
                    "source_block_ids": [],
                ...
                },
                {
                    ...
                    "visual_direction": "Highlight the value and unit separately.",
                    "equation_latex": None,
                ...
                },
                {
                    "slide_type": "takeaway",
                    "title": "Takeaway",
                    "onscreen": ["Report values with units."],
                    "narration": "A measurement becomes interpretable only when the value and its unit are reported together.",
                    "lecturer_notes": ["Close briefly."],
                    "visual_direction": "Return to 12.4 mm with a check mark.",
                    "equation_latex": None,
...
def test_llm_builder_adds_dedicated_narration_polish_and_preserves_provenance(tmp_path):
    ...
    assert manifest["editorial_status"] == "llm_draft_requires_review"
